register("Пциклический список", _ => {
    ...
    <p>Задача из необъятных просторов интернета. Дан односвязный список, в котором может
    быть цикл. Необходимо найти вершину, в которой начинается цикл, не используя при
    этом дополнительную память. Необходимо либо решить задачу, либо обосновать
    приведённое ниже решение.</p>
