...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("settings").addEventListener("change", _ => {
        startProcessing();
    })
...
async function startProcessing(files) {
    ...
    try {
        ...
        layout.fillDirection = document.getElementById("dir-select").value;
        layout.firstAxis = document.getElementById("rowcol-select").value === "cols" ? "horizontal" : "vertical";
