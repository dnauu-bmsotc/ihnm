...
По расположению тени на объекте можно определить, отрицательная эта форма рельефа или положительная. Также по тени можно грубо определить высоту объекта. Тень бывает *падающей* и *собственной*.
