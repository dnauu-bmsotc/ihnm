...
На современных топографических картах растительность показывают по основным жизненным формам растений. Разграничение производят по общей конституции, т. с, по строению и облику растений, среди которых выделяют:
- деревья;
- кустарники;
...
Деципиентные — труднодоступные наблюдению: почвы, геологическое строение.
