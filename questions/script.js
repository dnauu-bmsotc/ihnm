...
document.addEventListener("DOMContentLoaded", function() {
	...
	//let response = await fetch("./questions/mathematics.json");
  //
	//if (response.ok) {
	...
	//for (const [disciplineName, topics] of Object.entries(disciplines)) {
	...
	//			appendButton("themes-section", topicName, () => askTopic(topic));
	//		}
	//	});
	//}
});
...
let disciplines = {
	"Математика": {
		...
		"Дифференцирование функций одной переменной": [
			...
			"Первая и вторая теоремы Вейерштрасса для функций. Теорема Ферма. Без доказательств",
			...
			"Необходимые, достаточные условия возрастания (убывания) функции",
			"Точки минимума и максимума функции",
			"Необходимое условие экстремума. Достаточные условие экстремума",
